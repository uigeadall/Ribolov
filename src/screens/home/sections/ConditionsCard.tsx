...
const S = StyleSheet.create({
  ...
  stripTitle: { fontSize: 15, fontFamily: 'Nunito_800ExtraBold', letterSpacing: -0.2 },
  stripSub: { fontSize: 12, fontFamily: 'Nunito_600SemiBold', marginTop: 1 },
  ...
  metaValue: { fontSize: 13, fontFamily: 'Nunito_700Bold' },
  metaDivider: { width: StyleSheet.hairlineWidth },
  tip: { fontSize: 11, fontFamily: 'Nunito_600SemiBold', marginTop: spacing.sm },
  ...
  fcRain: { fontSize: 8, fontFamily: 'Nunito_400Regular' },
});
